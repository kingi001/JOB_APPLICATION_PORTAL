        ...
        <div class="py-1 mt-2 container mx-auto sm:px-6 lg:px-8 border border-gray-200 rounded-lg shadow-lg bg-white">
                            ...
                            <tbody class="text-gray-700 text-sm divide-y divide-gray-200">
                                @foreach ($employment as $employ)
                                    <tr>
                                        ...
                                        <td class="px-4 py-2">{{ $employ->designation }}</td>
                                        <td class="px-4 py-2">{{ $employ->job_scale }}</td>
                                        <td class="px-4 py-2">{{ $employ->organization }}</td>
                                        <td class="px-4 py-2">{{ Str::words($employ->duties, 10, '...') }}</td>
                                        <td class="px-4 py-2">{{ \Carbon\Carbon::parse($employ->start_date)->format('D M Y') }}
                                        </td>
                                        <td class="px-4 py-2">
                                            @if ($employ->end_date)
                                                {{ \Carbon\Carbon::parse($employ->end_date)->format('D M Y') }}
                                            @else
            ...
            <div class="mt-4 flex justify-end border-t border-gray-200 pt-2">
                ...
                <button type="button" onclick="handleEditClick()"
                    ...
                    <i class="fas fa-edit text-sm"></i> {{ __('Edit Employment') }}
                </button>
