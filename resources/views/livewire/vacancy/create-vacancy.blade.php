<div>
    <flux:modal name="create-vacancy" class="md:w-900">
        <div class="space-y-6">
            <input type="hidden" name="user_id" value="{{ auth()->id() }}">
            <div>
                <flux:heading size="lg">Add New Vacancy</flux:heading>
                <flux:text class="mt-2">Fill out the details below to post a new job vacancy.</flux:text>
            </div>
            <div class="grid grid-cols-1 md:grid-cols-2 gap-2">
                ...
                size="sm"
                name="ref_no"
                placeholder="e.g. BMA/VAC/001/2025"
                wire:model="ref_no"
                 />
                <flux:input
                label="Position"
                ...
                wire:model="terms_of_employment"
                required>
            ...
            name="duties"
            rows="5"
            placeholder="List the job duties..."
            wire:model="duties"
             />
